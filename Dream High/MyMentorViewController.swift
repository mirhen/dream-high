...
final class MyMentorViewController: UIViewController {
  //IBOutlet Buttons
...
extension MyMentorViewController: MFMailComposeViewControllerDelegate {
  func sendEmail() {
    ...
    //TODO: If we are targeting undocumented students maybe we should support additional langauges besides English
